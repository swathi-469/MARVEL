...
(k=String(k)),k=q(k)?/^\s*-?0x/i.test(k)?parseInt(k,16):parseInt(k,10):NaN)}return{host:b,port:k,domain:c,eh:d,mb:f,scheme:g,oc:e}}function rd(a){return fa(a)&&(a!=a||a==Number.POSITIVE_INFINITY||a==Number.NEGATIVE_INFINITY)}function sd(a){a()}function wc(a,b){if(a===b)return 0;if("[MIN_NAME]"===a||"[MAX_NAME]"===b)return-1;if("[MIN_NAME]"===b||"[MAX_NAME]"===a)return 1;var c=td(a),d=td(b);return null!==c?null!==d?0==c-d?a.length-b.length:c-d:-1:null!==d?1:a<b?-1:1}
...
h.$d=function(a,b){var c=Ce(this);c.oa=!0;p(a)||(a=null);c.hc=a;null!=b?(c.Nb=!0,c.zb=b):(c.Nb=!1,c.zb="");return c};h.sd=function(a,b){var c=Ce(this);c.ra=!0;p(a)||(a=null);c.ec=a;p(b)?(c.Wb=!0,c.xb=b):(c.qh=!1,c.xb="");return c};function De(a,b){var c=Ce(a);c.g=b;return c}function Ee(a){var b={};a.oa&&(b.sp=a.hc,a.Nb&&(b.sn=a.zb));a.ra&&(b.ep=a.ec,a.Wb&&(b.en=a.xb));if(a.la){b.l=a.ma;var c=a.Pb;""===c&&(c=Rd(a)?"l":"r");b.vf=c}a.g!==Q&&(b.i=a.g.toString());return b}
...
jh.prototype.open=function(a,b){this.jf=0;this.na=b;this.Df=new gh(a);this.Bb=!1;var c=this;this.sb=setTimeout(function(){c.f("Timed out trying to connect.");c.ab();c.sb=null},Math.floor(3E4));sd(function(){if(!c.Bb){c.Va=new mh(function(a,b,d,k,m){nh(c,arguments);if(c.Va)if(c.sb&&(clearTimeout(c.sb),c.sb=null),c.Ic=!0,"start"==a)c.id=b,c.Sg=d;else if("close"===a)b?(c.Va.Sf=!1,hh(c.Df,b,function(){c.ab()})):c.ab();else throw Error("Unrecognized command received: "+a);},function(a,b){nh(c,arguments);
ih(c.Df,a,b)},function(){c.ab()},c.hd);var a={start:"t"};a.ser=Math.floor(1E8*Math.random());c.Va.ih&&(a.cb=c.Va.ih);a.v="5";c.Wf&&(a.s=c.Wf);c.Db&&(a.ls=c.Db);a=c.hd(a);c.f("Connecting via long-poll to "+a);oh(c.Va,a,function(){})}})};jh.prototype.start=function(){var a=this.Va,b=this.Sg;a.Ke=this.id;a.Cf=b;for(a.ke=!0;ph(a););};
jh.isAvailable=function(){return kh||!lh&&"undefined"!==typeof document&&null!=document.createElement&&!("object"===typeof window&&window.chrome&&window.chrome.extension&&!/^chrome/.test(window.location.href))&&!("object"===typeof Windows&&"object"===typeof Windows.kh)&&!1};h=jh.prototype;h.Ed=function(){};h.cd=function(){this.Bb=!0;this.Va&&(this.Va.close(),this.Va=null);this.Bf&&(document.body.removeChild(this.Bf),this.Bf=null);this.sb&&(clearTimeout(this.sb),this.sb=null)};
h.ab=function(){this.Bb||(this.f("Longpoll is closing itself"),this.cd(),this.na&&(this.na(this.Ic),this.na=null))};h.close=function(){this.Bb||(this.f("Longpoll is being closed."),this.cd())};h.send=function(a){a=F(a);this.qb+=a.length;pc(this.Wa,"bytes_sent",a.length);a=Mb(a);a=mb(a,!0);a=wd(a,1840);for(var b=0;b<a.length;b++){var c=this.Va;c.$c.push({Xg:this.jf,gh:a.length,lf:a[b]});c.ke&&ph(c);this.jf++}};function nh(a,b){var c=F(b).length;a.pb+=c;pc(a.Wa,"bytes_received",c)}
function mh(a,b,c,d){this.hd=d;this.jb=c;this.Qe=new sg;this.$c=[];this.se=Math.floor(1E8*Math.random());this.Sf=!0;this.pg=a;this.Jg=b}mh.prototype.close=function(){this.ke=!1;if(this.Gd){this.Gd.mh.body.innerHTML="";var a=this;setTimeout(function(){null!==a.Gd&&(document.body.removeChild(a.Gd),a.Gd=null)},Math.floor(0))}if(this.Ke){var b={disconn:"t"};b.id=this.Ke;b.pw=this.Cf;b=this.hd(b);qh(b)}if(b=this.jb)this.jb=null,b()};
function ph(a){if(a.ke&&a.Sf&&a.Qe.count()<(0<a.$c.length?2:1)){a.se++;var b={};b.id=a.Ke;b.pw=a.Cf;b.ser=a.se;for(var b=a.hd(b),c="",d=0;0<a.$c.length;)if(1870>=a.$c[0].lf.length+30+c.length){var e=a.$c.shift(),c=c+"&seg"+d+"="+e.Xg+"&ts"+d+"="+e.gh+"&d"+d+"="+e.lf;d++}else break;rh(a,b+c,a.se);return!0}return!1}function rh(a,b,c){function d(){a.Qe.remove(c);ph(a)}a.Qe.add(c,1);var e=setTimeout(d,Math.floor(25E3));oh(a,b,function(){clearTimeout(e);d()})}function oh(a,b,c){sh(a,b,c)}var th=null;
function qh(a,b){th||(th=require("request"));th(a,function(c,d,e){if(c)throw"Rest request for "+a.url+" failed.";b&&b(e)})}function sh(a,b,c){qh({url:b,nh:!0},function(b){uh(a,b);c()})}function uh(a,b){eval("var jsonpCB = function(pLPCommand, pRTLPCB) {"+b+"}");jsonpCB(a.pg,a.Jg)};var vh=null,vh=require("faye-websocket").Client;function wh(a,b,c,d){this.qe=a;this.f=nd(this.qe);this.frames=this.Lc=null;this.pb=this.qb=this.cf=0;this.Wa=sc(b);a={v:"5"};c&&(a.s=c);d&&(a.ls=d);this.ff=dd(b,ed,a)}var xh;
wh.prototype.open=function(a,b){this.jb=b;this.Ig=a;this.f("Websocket connecting to "+this.ff);this.Ic=!1;$c.set("previous_websocket_failure",!0);try{this.Ka=new vh(this.ff,[],{headers:{"User-Agent":"Firebase/5/"+Cb+"/"+process.platform+"/Node"}})}catch(c){this.f("Error instantiating WebSocket.");var d=c.message||c.data;d&&this.f(d);this.ab();return}var e=this;this.Ka.onopen=function(){e.f("Websocket connected.");e.Ic=!0};this.Ka.onclose=function(){e.f("Websocket connection was disconnected.");e.Ka=
...
function Oh(a){a.Cb||1!==a.N||(a.f("sending ping on primary."),Qh(a,{t:"c",d:{t:"p",d:{}}}))}function Qh(a,b){if(1!==a.N)throw"Connection is not connected";a.gd.send(b)}Fh.prototype.close=function(){2!==this.N&&(this.f("Closing realtime connection."),this.N=2,Mh(this),this.na&&(this.na(),this.na=null))};function Mh(a){a.f("Shutting down all connections");a.K&&(a.K.close(),a.K=null);a.F&&(a.F.close(),a.F=null);a.yd&&(clearTimeout(a.yd),a.yd=null)};function Rh(a,b,c,d){this.id=Sh++;this.f=nd("p:"+this.id+":");this.yf=this.Ee=!1;this.ba={};this.sa=[];this.Zc=0;this.Wc=[];this.qa=!1;this.bb=1E3;this.Fd=3E5;this.Ib=b;this.Vc=c;this.Pe=d;this.G=a;this.ub=this.Ca=this.La=this.Db=this.Xe=null;this.Qb=!1;this.Ud={};this.Wg=0;this.of=!0;this.Mc=this.Ge=null;Th(this,0);hf.wb().Gb("visible",this.Mg,this);-1===a.host.indexOf("fblocal")&&gf.wb().Gb("online",this.Kg,this)}var Sh=0,Uh=0;h=Rh.prototype;
h.Ha=function(a,b,c){var d=++this.Wg;a={r:d,a:a,b:b};this.f(F(a));N(this.qa,"sendRequest call when we're not connected not allowed.");this.La.Ha(a);c&&(this.Ud[d]=c)};h.zf=function(a,b,c,d){var e=a.wa(),f=a.path.toString();this.f("Listen called for "+f+" "+e);this.ba[f]=this.ba[f]||{};N(Ge(a.n)||!Fe(a.n),"listen() called for non-default but complete query");N(!this.ba[f][e],"listen() called twice for same path/queryId.");a={I:d,xd:b,Tg:a,tag:c};this.ba[f][e]=a;this.qa&&Vh(this,a)};
function Vh(a,b){var c=b.Tg,d=c.path.toString(),e=c.wa();a.f("Listen on "+d+" for "+e);var f={p:d};b.tag&&(f.q=Ee(c.n),f.t=b.tag);f.h=b.xd();a.Ha("q",f,function(f){var k=f.d,m=f.s;if(k&&"object"===typeof k&&y(k,"w")){var l=z(k,"w");da(l)&&0<=Ma(l,"no_index")&&R("Using an unspecified index. Consider adding "+('".indexOn": "'+c.n.g.toString()+'"')+" at "+c.path.toString()+" to your security rules for better performance")}(a.ba[d]&&a.ba[d][e])===b&&(a.f("listen response",f),"ok"!==m&&Wh(a,d,e),b.I&&
...
oi.prototype.lb=function(a,b,c){var d=a.path,e=this.va.get(d),f=[];if(e&&("default"===a.wa()||null!=ni(e,a))){f=e.lb(a,b,c);e.e()&&(this.va=this.va.remove(d));e=f.Vg;f=f.vg;b=-1!==Ta(e,function(a){return Fe(a.n)});var g=vf(this.va,d,function(a,b){return null!=li(b)});if(b&&!g&&(d=this.va.subtree(d),!d.e()))for(var d=Ci(d),k=0;k<d.length;++k){var m=d[k],l=m.Y,m=Di(this,m);this.Oc.Ye(Ei(l),Fi(this,l),m.xd,m.I)}if(!g&&0<e.length&&!c)if(b)this.Oc.ae(Ei(a),null);else{var r=this;Na(e,function(a){a.wa();
...
function Ki(a,b,c){b=new O("/.info/"+b);c=P(c);var d=a.Ce;d.Xd=d.Xd.H(b,c);c=qi(a.Cd,new yc(Ef,b,c));bc(a.fa,b,c)}h.Mb=function(a,b,c,d){this.f("set",{path:a.toString(),value:b,ph:c});var e=Mi(this);b=P(b,c);var e=Vc(b,e),f=this.Id++,e=pi(this.M,a,e,f,!0);Yb(this.fa,e);var g=this;this.da.put(a.toString(),b.J(!0),function(b,c){var e="ok"===b;e||R("set at "+a+" failed: "+b);e=si(g.M,f,!e);bc(g.fa,a,e);Pi(d,b,c)});e=Qi(this,a);Ni(this,e);bc(this.fa,e,[])};
...
function Yi(a,b,c){if(0!==b.length){for(var d=[],e=[],f=Pa(b,function(a){return a.Da}),g=0;g<b.length;g++){var k=b[g],m=jf(c,k.path),l=!1,r;N(null!==m,"rerunTransactionsUnderNode_: relativePath should not be null.");if(5===k.status)l=!0,r=k.je,e=e.concat(si(a.M,k.Da,!0));else if(1===k.status)if(25<=k.Qf)l=!0,r="maxretry",e=e.concat(si(a.M,k.Da,!0));else{var x=a.M.Aa(k.path,f)||G;k.od=x;var J=b[g].update(x.J());p(J)?(fg("transaction failed: Data returned ",J,k.path),m=P(J),"object"===typeof J&&null!=
J&&y(J,".priority")||(m=m.ia(x.C())),x=k.Da,J=Mi(a),J=Vc(m,J),k.pd=m,k.qd=J,k.Da=a.Id++,Ua(f,x),e=e.concat(pi(a.M,k.path,J,k.Da,k.df)),e=e.concat(si(a.M,x,!0))):(l=!0,r="nodata",e=e.concat(si(a.M,k.Da,!0)))}bc(a.fa,c,e);e=[];l&&(b[g].status=3,setTimeout(b[g].he,Math.floor(0)),b[g].I&&("nodata"===r?(k=new X(a,b[g].path),d.push(u(b[g].I,null,null,!1,new W(b[g].od,k,Q)))):d.push(u(b[g].I,null,Error(r),!1,null))))}Ui(a,a.xc);for(g=0;g<d.length;g++)ec(d[g]);Ti(a)}}
...
h.Ng=function(a,b){function c(k){f&&(f=!1,e.kc(a,c),b&&b.call(d.Pa,k),g.resolve(k))}C("Query.once",1,4,arguments.length);jg("Query.once",a,!1);E("Query.once",2,b,!0);var d=ej("Query.once",arguments[2],arguments[3]),e=this,f=!0,g=new A;Lb(g.D);this.Gb(a,c,function(b){e.kc(a,c);d.cancel&&d.cancel.call(d.Pa,b);g.reject(b)});return g.D};
...
h.Og=function(a){C("Query.orderByChild",1,1,arguments.length);if("$key"===a)throw Error('Query.orderByChild: "$key" is invalid.  Use Query.orderByKey() instead.');if("$priority"===a)throw Error('Query.orderByChild: "$priority" is invalid.  Use Query.orderByPriority() instead.');if("$value"===a)throw Error('Query.orderByChild: "$value" is invalid.  Use Query.orderByValue() instead.');lg("Query.orderByChild",a);dj(this,"Query.orderByChild");var b=new O(a);if(b.e())throw Error("Query.orderByChild: cannot pass in empty path.  Use Query.orderByValue() instead.");
b=new te(b);b=De(this.n,b);bj(b);return new Y(this.k,this.path,b,!0)};h.Pg=function(){C("Query.orderByKey",0,0,arguments.length);dj(this,"Query.orderByKey");var a=De(this.n,pe);bj(a);return new Y(this.k,this.path,a,!0)};h.Qg=function(){C("Query.orderByPriority",0,0,arguments.length);dj(this,"Query.orderByPriority");var a=De(this.n,Q);bj(a);return new Y(this.k,this.path,a,!0)};
h.Rg=function(){C("Query.orderByValue",0,0,arguments.length);dj(this,"Query.orderByValue");var a=De(this.n,ze);bj(a);return new Y(this.k,this.path,a,!0)};h.$d=function(a,b){C("Query.startAt",0,2,arguments.length);eg("Query.startAt",a,this.path,!0);kg("Query.startAt",b);var c=this.n.$d(a,b);cj(c);bj(c);if(this.n.oa)throw Error("Query.startAt: Starting point was already set (by another call to startAt or equalTo).");p(a)||(b=a=null);return new Y(this.k,this.path,c,this.nc)};
...
function ej(a,b,c){var d={cancel:null,Pa:null};if(b&&c)d.cancel=b,E(a,3,d.cancel,!0),d.Pa=c,Ob(a,4,d.Pa);else if(b)if("object"===typeof b&&null!==b)d.Pa=b;else if("function"===typeof b)d.cancel=b;else throw Error(D(a,3,!0)+" must either be a cancel callback or a context object.");return d}Y.prototype.ref=Y.prototype.Kb;Y.prototype.on=Y.prototype.Gb;Y.prototype.off=Y.prototype.kc;Y.prototype.once=Y.prototype.Ng;Y.prototype.limit=Y.prototype.He;Y.prototype.limitToFirst=Y.prototype.Ie;
Y.prototype.limitToLast=Y.prototype.Je;Y.prototype.orderByChild=Y.prototype.Og;Y.prototype.orderByKey=Y.prototype.Pg;Y.prototype.orderByPriority=Y.prototype.Qg;Y.prototype.orderByValue=Y.prototype.Rg;Y.prototype.startAt=Y.prototype.$d;Y.prototype.endAt=Y.prototype.sd;Y.prototype.equalTo=Y.prototype.tg;Y.prototype.toString=Y.prototype.toString;var Z={};Z.yc=Rh;Z.DataConnection=Z.yc;Rh.prototype.bh=function(a,b){this.Ha("q",{p:a},b)};Z.yc.prototype.simpleListen=Z.yc.prototype.bh;Rh.prototype.sg=function(a,b){this.Ha("echo",{d:a},b)};Z.yc.prototype.echo=Z.yc.prototype.sg;Rh.prototype.interrupt=Rh.prototype.Ab;Z.cg=Fh;Z.RealTimeConnection=Z.cg;Fh.prototype.sendRequest=Fh.prototype.Ha;Fh.prototype.close=Fh.prototype.close;
Z.Cg=function(a){var b=Rh.prototype.put;Rh.prototype.put=function(c,d,e,f){p(f)&&(f=a());b.call(this,c,d,e,f)};return function(){Rh.prototype.put=b}};Z.hijackHash=Z.Cg;Z.bg=bd;Z.ConnectionTarget=Z.bg;Z.wa=function(a){return a.wa()};Z.queryIdentifier=Z.wa;Z.Eg=function(a){return a.k.Ua.ba};Z.listens=Z.Eg;Z.ve=function(a){a.ve()};Z.forceRestClient=Z.ve;function X(a,b){var c,d,e;if(a instanceof Ji)c=a,d=b;else{C("new Firebase",1,2,arguments.length);d=qd(arguments[0]);c=d.eh;"firebase"===d.domain&&pd(d.host+" is no longer supported. Please use <YOUR FIREBASE>.firebaseio.com instead");c&&"undefined"!=c||pd("Cannot parse Firebase url. Please use https://<YOUR FIREBASE>.firebaseio.com");d.mb||"undefined"!==typeof window&&window.location&&window.location.protocol&&-1!==window.location.protocol.indexOf("https:")&&R("Insecure Firebase access from a secure page. Please use https in calls to new Firebase().");
...
d.reject(a):d.resolve(new ei(c,g));t(b)&&b(a,c,g)},c);return d.D};X.prototype.transaction=X.prototype.transaction;X.prototype.Zg=function(a,b){C("Firebase.setPriority",1,2,arguments.length);mg("Firebase.setPriority",this.path);ig("Firebase.setPriority",1,a);E("Firebase.setPriority",2,b,!0);var c=new A;this.k.Mb(this.path.o(".priority"),a,null,B(c,b));return c.D};X.prototype.setPriority=X.prototype.Zg;
...
X.prototype.xe=function(){C("Firebase.getAuth",0,0,arguments.length);return this.k.O.xe()};X.prototype.getAuth=X.prototype.xe;X.prototype.Gg=function(a,b){C("Firebase.onAuth",1,2,arguments.length);E("Firebase.onAuth",1,a,!1);Ob("Firebase.onAuth",2,b);this.k.O.Gb("auth_status",a,b)};X.prototype.onAuth=X.prototype.Gg;X.prototype.Fg=function(a,b){C("Firebase.offAuth",1,2,arguments.length);E("Firebase.offAuth",1,a,!1);Ob("Firebase.offAuth",2,b);this.k.O.kc("auth_status",a,b)};X.prototype.offAuth=X.prototype.Fg;
